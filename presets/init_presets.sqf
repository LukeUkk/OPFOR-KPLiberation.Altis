...
switch (KP_liberation_preset_opfor) do {
	...
	case 6: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\rhs_usaf_wdl.sqf";};
	case 7: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\rhs_usaf_des.sqf";};
