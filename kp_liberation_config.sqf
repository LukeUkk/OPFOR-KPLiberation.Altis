...
box_transport_config = [
	...
	["RHS_Mi8mt_vvs", -8, [0,3.2,-1.2], [0,1.2,-1.2], [0,-0.8,-1.2]],
	...
	["rhs_pts_vmf", -7.0, [0.8,2.6,0.30],[-0.8,2.6,0.30],[0.8,0.95,0.30],[-0.8,0.95,0.30],[0.8,-0.8,0.30],[-0.8,-0.8,0.30],[0.8,-2.4,0.30],[-0.8,-2.4,0.30] ]
];
