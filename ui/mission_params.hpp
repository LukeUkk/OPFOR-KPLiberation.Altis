class Params
{
	...
	//	Added AIS By Luke
	class AISREVIVEINITUNITS {
		title = $STR_AIS_REVIVE_INIT_UNITS;
		values[] = {0,1,2,3,4,5,6};
		texts[] = {allPlayers ,allPlayables ,allUnits,allUnitsBLUFOR,allUnitsOPFOR,allUnitsINDFOR,allUnitsCIVILIAN};
		default = 1;
	};
	class AISMEDICALEDUCATION {
		title = $STR_AIS_MEDICAL_EDUCATION;
		values[] = {0,1,2};
		texts[] = {$STR_EDUCATION_EVERYBODY,Everybody with a First Aid Kit or Medkit, Only Medics (this affects both AI and players!)};
		default = 1;
	};
	class AISREVIVEGUARANTY {
		title = $STR_AIS_REVIVE_GUARANTY;
		values[] = {0,1};
		texts[] = {$STR_NO,$STR_YES};
		default = 1;
	};
	class AISBLEEDOUTTIME {
		title = $STR_AIS_BLEEDOUT_TIME;
		values[] = {50,100,150,200,300};
		texts[] = {50,100,150,200,300};
		default = 300;
	};
	class AIS_REVIVETIME {
		title = $STR_AIS_REVIVETIME;
		values[] = {10,20,30,40,50};
		texts[] = {10,20,30,40,50};
		default = 30;
	};
	class AIS_STABILIZETIME {
		title = $STR_AIS_STABILIZETIME;
		values[] = {10,20,30,40,50};
		texts[] = {10,20,30,40,50};
		default = 20;
	};
	class AIS_REVIVE_HEAL {
		title = NEW: AIS REVIVE HEAL;
		values[] = {0,1};
		texts[] = {$STR_NO,$STR_YES};
		default = 0;
	};
	class AIS_TOGGLE_RADIO {
		title = NEW: AIS TOGGLE RADIO;
		values[] = {0,1};
		texts[] = {$STR_NO,$STR_YES};
		default = 1;
	};
	class AIS_NO_CHAT {
		title = NEW: AIS NO CHAT;
		values[] = {0,1};
		texts[] = {$STR_NO,$STR_YES};
		default = 1;
	};
	class AIS_AI_HELP_RADIUS {
		title = NEW: AIS AI HELP RADIUS;
		values[] = {100,200,300,400};
		texts[] = {100,200,300,400};
		default = 100;
	};
	class Spacer2 {
		title = "";
	...
	/*
	class Haloaltitude {
		title = NEW: HALO ALTITUDE;
		values[] = {500,1000,1500,2000};
		texts[] = {500,1000,1500,2000};
		default = 1500;
	};
	*/
	class ClearCargo {
